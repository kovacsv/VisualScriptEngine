...
TEST (TestListBuilderNode)
{
	...
	UINodePtr intNode = uiManager.AddNode (UINodePtr (new IntegerUpDownNode (String (L"Value1"), Point (0, 0), 1, 1)), EmptyEvaluationEnv);
	UINodePtr intIncNode = uiManager.AddNode (UINodePtr (new IntegerIncrementedNode (String (L"Value2"), Point (0, 0))), EmptyEvaluationEnv);
	UINodePtr listBuilder = uiManager.AddNode (UINodePtr (new ListBuilderNode (String (L"List Builder"), Point (0, 0))), EmptyEvaluationEnv);
