...
void NodeUILeftRightButtonsPanel::Draw (NodeUIEnvironment& env, const Rect& rect, NodeDrawingImage& drawingImage) const
{
	...
	drawingImage.AddItem (DrawingItemConstPtr (new DrawingFillRect (leftButtonRect, GetButtonBackgroundColor (env))));
	drawingImage.AddItem (DrawingItemConstPtr (new DrawingRect (leftButtonRect, GetButtonBorderPen (env))));
	drawingImage.AddItem (DrawingItemConstPtr (new DrawingText (leftButtonRect, skinParams.GetNodeTextFont (), leftButtonText, HorizontalAnchor::Center, VerticalAnchor::Center, GetTextColor (env))));
	...
	drawingImage.AddItem (DrawingItemConstPtr (new DrawingFillRect (rightButtonRect, GetButtonBackgroundColor (env))));
	drawingImage.AddItem (DrawingItemConstPtr (new DrawingRect (rightButtonRect, GetButtonBorderPen (env))));
	drawingImage.AddItem (DrawingItemConstPtr (new DrawingText (rightButtonRect, skinParams.GetNodeTextFont (), rightButtonText, HorizontalAnchor::Center, VerticalAnchor::Center, GetTextColor (env))));
