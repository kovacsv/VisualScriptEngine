#ifndef APPDRAWINGCONTEXT_HPP
#define APPDRAWINGCONTEXT_HPP

#include "DrawingContext.hpp"

#include "wx/dcmemory.h"

class AppDrawingContext : public NUIE::DrawingContext
{
public:
	AppDrawingContext ();
	AppDrawingContext (const AppDrawingContext& rhs) = delete;
	virtual ~AppDrawingContext ();
