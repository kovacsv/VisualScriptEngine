...
"C:\Program Files (x86)\PVS-Studio\PlogConverter.exe" ../Build/Debug/VisualScriptEngine.plog --outputDir ../Build/Debug -t Html
start ..\Build\Debug\VisualScriptEngine.plog.html
